 ...
 */
public class TSPView2 extends JPanel implements ProblemView{
     ...
     * @param tsp
	 */
	public TSPView2(TSP2 tsp, int sizePx){
		this.tsp = tsp;
		this.sizePx = sizePx;
	...
	private void generateMazeImage(){
		...
		// Background
		mazeGraphics2D.setColor(Color.ORANGE);
		mazeGraphics2D.fillRect(0, 0, sizePx, sizePx);	
		// Cities
		mazeGraphics2D.setColor(Color.DARK_GRAY);
